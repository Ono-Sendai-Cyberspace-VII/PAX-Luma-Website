  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-6">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(60,219,192,0.15) 1px, transparent 1px), linear-gradient(90deg, rgba(60,219,192,0.15) 1px, transparent 1px)",
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black tracking-tight leading-[0.95]"
        >
